...
const useGettingQuiz = () => {
    ...
    async function publicQuizzes() {
        try {
            const response = await fetch('/api/quizzes/public', { method: 'GET' });
    ...
    async function featuredQuizzes() {
        try {
            const response = await fetch('/api/quizzes/featured', { method: 'GET' });
            const res = await response.json();
            if (!response.ok) throw { response: { data: res } }
            return res;
        } catch (err: any) {
    ...
    async function userPublicQuizzes(userId: string) {
        try {
            const response = await fetch(`/api/quizzes/public/${userId}`, { method: 'GET' });
            const res = await response.json();
            if (!response.ok) throw { response: { data: res } }
            return res;
        } catch (err: any) {
    ...
    async function userPrivateQuizzes() {
        try {
    ...
    async function userDraftsQuizzes() {
        try {
    ...
    async function userSavesQuizzes() {
        try {
    ...
    async function searchQuiz(title: string | undefined, categories: string | undefined, tags: string | undefined) {
        try {
            ...
            const response = await fetch(`/api/quizzes/search?${params.toString()}`, { method: 'GET' });
            const res = await response.json();
            if (!response.ok) throw { response: { data: res } }
            return res;
        } catch (err: any) {
